...
$search_results = $lib->request('/videos', array('page' => 1, 'per_page' => 50, 'query' => urlencode($_GET['query']), 'sort' => 'relevant', 'direction' => 'desc', 'filter' => ''),'GET');
print_r($search_results['body']);