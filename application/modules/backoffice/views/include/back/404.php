        ...
        <div class="center-panel col-sm-6 col-sm-offset-3 col-xs-offset-1">
            <div class="text-center animated fadeInDown">
                <ul class="list-unstyled">
                    <li class="text-transparent padding-bottom animated shake"><div class="huge-text">404</div></li>
                    <li>
                        <h2 class="text-center">Requested page not found! Let's head back to the <a href="<?= ROOT_URL; ?>" class="text-transparent" style="text-decoration:underline">Home Page</a></h2>
                    </li>
                </ul>
                <br>
                <div class="row">
