            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.response) {
                        ...
                        DialogError_isFree(data.message);
...
function validate_form_add() {
    ...
    $("#form_add_video").validate({
        ...
        messages: {
            ...
            video_preview: "Seleccione un video corto.",
            video_full: "Seleccione un video FULL HD",
...
function formVideo() {
    ...
    var urlFormSave = $Ctr_video + 'save_video';

    var formData = new FormData();
    /* GET DATA*/
    var video_preview = $("#video_preview")[0].files[0];
    var video_full = $("#video_full")[0].files[0];
    ...
    /*  DATOS VIDEOS  */
    formData.append('video_preview', video_preview);
    formData.append('video_full', video_full);
    ...
    if (typeof video_preview != 'undefined' && typeof video_full != 'undefined' && typeof image_name != 'undefined') {
 ...
 * @type Arguments
 */
function DialogError_isFree(message) {
