                    ...
                    <div class="panel panel-default divcenter noradius noborder" style="max-width: 400px;">
                        <div class="panel-body" style="padding: 40px;">
                            <form id="recovery-form" class="nobottommargin" onsubmit="return validateRecovery();">
                                <h3><?= $this->lang->line('recovery_title') ?></h3>
                                <h5><?= $this->lang->line('recovery_subtitle') ?></h5>

                                <div class="col_full">
                                    <label for="login-form-username"><?= $this->lang->line('recovery_form_email') ?>:</label>
                                    <input type="text" id="email" name="email" value="" class="form-control not-dark"/>
                                </div>
                                <div class="col_full nobottommargin">
                                    <button class="button button-3d button-black nomargin" id="login-form-submit" style="width: 100%;"
                                            name="login-form-submit" value="login"><?= $this->lang->line('recovery_form_button') ?>
                                    </button>
                                </div>
                            </form>
