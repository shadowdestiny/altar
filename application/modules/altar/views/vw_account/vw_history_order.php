...
<section id="content">
    ...
    <div class="header-order">
        <div class="row">
            <div class="col-md-4 col-sm-4 section-top-account">
                <h4 class=""><?= $this->lang->line('account_product') ?></h4>
            </div>
            <div class="col-md-4 col-sm-4 section-top-account">
                <h4 class=""><?= $this->lang->line('account_price') ?></h4>
            </div>
            <div class="col-md-4 col-sm-4 section-top-account">
                <h4 class=""><?= $this->lang->line('account_download') ?></h4>
            </div>
        </div>
    </div>
