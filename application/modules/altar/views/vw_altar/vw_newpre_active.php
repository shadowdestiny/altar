...
<div id="wrapper" class="clearfix">
    ...
    <section id="content" class="seccionapara">
        <div class="container">
            ...
            <h1 class="center textocentral legendcreative">¡GRACIAS POR SUSCRIBIRTE!</h1>
    ...
    <section id="content" style="padding: 100px">
        <div class="row clearfix">
            ...
            <div class="heading-block nobottomborder">
                <h2 class="delgadini"><strong>DESCARGA GRATUITA</strong><span> DE LA SEMANA</span></h2>
            </div>

            <div class="col-md-6 ">
                <div class="text-right bottommargin">
                    <video width="100%" poster="<?= URL_TEMPLATEFRONTNEW; ?>images/video-01.jpg" autoplay="autoplay">
                        <source src="<?= URL_TEMPLATEFRONTNEW; ?>videos/changetheworld.mp4" type="video/mp4">
            ...
            <div class="col-md-6 col-padding">
                <h3 class="pads"><b>FAIRHFULNESS</b><br>HILLSONG WORSHIP</h3>
                <a href="<?= URL_TEMPLATEFRONTNEW; ?>videos/changetheworld.mp4" download="changetheworld.mp4"
                   class="button button-3d button-black nomargin">DESCARGAR</a>
            </div>
