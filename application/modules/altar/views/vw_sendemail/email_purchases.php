...
<table class="nl-container"
    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <div style="background-color:#071C2C;">
                <div style="Margin: 0 auto;min-width: 320px;max-width: 620px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="background-color:#071C2C;" align="center">
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div align="center" class="img-container center  autowidth "
                                        ...
                                        <img class="center  autowidth " align="center" border="0"
                                             src="<?= URL_ASSETS; ?>mail/crative_logo.png" alt="Image" title="Image"
                                             style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 241px"
                                             width="241">
                                    ...
                                    <div align="center" class="img-container center  autowidth "
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 0px;" align="center">
                                        <![endif]-->
                                        <img class="center  autowidth " align="center" border="0" src="<?= URL_ASSETS; ?>mail/okok.gif"
                                                    ...
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <div class="txtTinyMce-wrapper"
                                                             style="font-size: 12px; line-height: 14px;"><p
                                                                    style="margin: 0;font-size: 14px;line-height: 16px;text-align: center">
                                                                <strong><span
                                                                            style="font-size: 18px; line-height: 21px;">Thank you for placing your order</span></strong>
                                                            </p>
                                                            <p style="margin: 0;font-size: 14px;line-height: 16px;text-align: center">
                                                                <strong><span
                                                                            style="font-size: 18px; line-height: 21px;">with our store!</span></strong>
                                                            </p></div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div style="font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#71777D; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 25px;">
                                        <div style="font-size:12px;line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;color:#71777D;text-align:left;">
                                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                                                This email is to confirm your recent order.</p></div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
            ...
            <div style="background-color:transparent;">
                <div style="Margin: 0 auto;min-width: 320px;max-width: 620px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #000000;"
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div style="font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#FFFFFF; padding-right: 20px; padding-left: 20px; padding-top: 10px; padding-bottom: 10px;">
                                        <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;">
                                            <div class="txtTinyMce-wrapper" style="font-size:12px; line-height:14px;"><p
                                                        style="margin: 0;font-size: 14px;line-height: 16px">PRODUCTS</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                     style="font-size: 12px; line-height: 14px;"><p
                                                            style="margin: 0;font-size: 14px;line-height: 16px"><span
                                                                style="font-size: 14px; line-height: 16px;">PRICE</span><br>
                                                    </p></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div style="display: table; max-width:141px;">
                                            ...
                                            <table align="left" border="0" cellspacing="0" cellpadding="0" width="32"
                                                ...
                                                <tr style="vertical-align: top">
                                                    <td align="left" valign="middle"
                                                        ...
                                                        <a href="<?= URL_FACEBOOK; ?>" title="Facebook"
                                                           target="_blank">
                                                            <img src="<?= URL_ASSETS; ?>mail/images/socialblack.png" alt="Facebook"
                                            ...
                                            <table align="left" border="0" cellspacing="0" cellpadding="0" width="32"
                                                ...
                                                <tr style="vertical-align: top">
                                                    <td align="left" valign="middle"
                                                        style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                        <a href="<?= URL_TWITTER; ?>" title="Twitter" target="_blank">
                                                            <img src="<?= URL_ASSETS; ?>mail/images/icon-56729black.png" alt="Twitter"
                                            ...
                                            <table align="left" border="0" cellspacing="0" cellpadding="0" width="32"
                                                ...
                                                <tr style="vertical-align: top">
                                                    <td align="left" valign="middle"
                                                        style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                        <a href="<?= URL_GOOGLEPLUS; ?>" title="Google+"
                                                           target="_blank">
                                                            <img src="<?= URL_ASSETS; ?>mail/images/icon-56720black.png" alt="Google+"
            ...
            <div style="background-color:#071C2C;">
                <div style="Margin: 0 auto;min-width: 320px;max-width: 620px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #071C2C;"
                     class="block-grid ">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#071C2C;">
                        <!--[if (mso)|(IE)]>
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="background-color:#071C2C;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width: 620px;">
                                        <tr class="layout-full-width" style="background-color:#071C2C;"><![endif]-->
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div style="font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;color:#555555; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                        <div style="font-size:12px;line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;color:#555555;text-align:left;">
                                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                                                Copyright © Creative Altar 2017<br><span
                                            ...
                                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                                                <span style="font-size: 12px; line-height: 14px;">
                                                    <a
                                                            style="color:#FBCE01;color:#FBCE01;color:#FBCE01;text-decoration: underline;"
                                                            href="<?= ROOT_URL; ?>altar/Ctr_termsconditions"
                                                            target="_blank" rel="noopener noreferrer"
                                                            data-mce-selected="1">Terminos y Condiciones﻿</a>
                                                </span>
                                                <span style="font-size: 12px; line-height: 14px;">
                                                    <a
                                                            style="color:#FBCE01;color:#FBCE01;color:#FBCE01;text-decoration: underline;"
                                                            href="<?= ROOT_URL; ?>altar/Ctr_privacy" target="_blank"
                                                            rel="noopener noreferrer"
                                                            data-mce-selected="1">Aviso de privacidad﻿</a>
                                                </span>
                                            </p></div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
