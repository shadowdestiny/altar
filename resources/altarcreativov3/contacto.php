<?php include("includes/header.php"); ?>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				<h1>Contacto</h1>
				<span>Escríbenos tus dudas y comentarios</span>
					...
					<div class="col_half">
						...
						<div class="contact-widget">
							...
							<form class="nobottommargin" id="template-contactform" name="template-contactform" action="#" method="post">
								...
								<div class="col_full">
									<button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit" class="button button-3d nomargin">Enviar mensaje</button>
								</div>
					...
					<div class="col_half col_last">
					    <div class="widget clearfix">
								...
								<div id="oc-clients-full" class="owl-carousel image-carousel carousel-widget" data-items="1" data-margin="10" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false">
									...
									<div class="oc-item"><a href="#"><img src="img/bn-pub4.jpg" alt="Publicidad"></a></div>
									<div class="oc-item"><a href="#"><img src="img/bn-pub3.jpg" alt="Publicidad"></a></div>
									<div class="oc-item"><a href="#"><img src="img/bn-pub4.jpg" alt="Publicidad"></a></div>
									<div class="oc-item"><a href="#"><img src="img/bn-pub3.jpg" alt="Publicidad"></a></div>
									<div class="oc-item"><a href="#"><img src="img/bn-pub3.jpg" alt="Publicidad"></a></div>
									<div class="oc-item"><a href="#"><img src="img/bn-pub4.jpg" alt="Publicidad"></a></div>
